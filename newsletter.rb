...
def calculate_recipients
  ...
  # OR
  SUBSCRIBERS.delete_if do |email|
...
def print_one_article(article)
  # article = {"author": "Destiny Blanda Bruen II", "title": "Mining", "text": "The orthogonal features, when combined, can explode into complexity."}
